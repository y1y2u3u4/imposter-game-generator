        ...
        >
          ...
          <motion.div variants={staggerItem} className="prose prose-invert prose-lg max-w-none">
            <p className="text-muted-foreground leading-relaxed mb-6">
              The <strong className="text-foreground">Imposter Game</strong>, also known as the Spy Game or Word Spy,
              is an exciting social deduction party game that has taken gatherings by storm. This thrilling word-based game
              challenges players to identify the hidden player among them through clever questioning and deductive reasoning.
              Perfect for parties, family gatherings, team building events, and casual hangouts, this game creates
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              receiving the "spy" role who must blend in without knowing the actual word.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              At the start of each round, our word generator distributes secret words to all players. Regular players
              receive the same word (for example, "Lion"), while the spy receives a different but related word (such as
              "Tiger"). Players take turns describing their word without saying it directly, trying to prove they know the
              real word while simultaneously identifying who might be the hidden player. The spy must listen carefully to
              other players' descriptions and bluff convincingly to avoid detection.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              After several rounds of descriptions and discussions, players vote on who they believe is the spy.
              If the group correctly identifies them, they win! However, if the spy remains undetected or
              ...
              information that could help the hidden player.
            </p>

            <h3 className="text-xl font-semibold text-foreground mt-8 mb-4 flex items-center gap-2">
              <Users className="w-5 h-5 text-primary" />
              Why Choose Our Word Game Generator?
            </h3>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              To maximize your gaming experience, consider these expert tips: For regular players, give descriptions
              that are specific enough to prove you know the word but vague enough to not help the spy. Watch other
              players' reactions carefully - hesitation or overly generic descriptions might indicate the hidden player. As the
              spy, pay close attention to patterns in other players' descriptions to deduce the real word. Use confident
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              This word game generator is perfect for birthday parties, holiday gatherings, office team building events,
              classroom activities, road trips, and casual game nights. Its simple rules make it accessible to players of
              all ages (recommended for ages 8 and up), while the strategic depth keeps experienced gamers engaged. Each
              round typically runs 5-15 minutes, making it easy to fit into any schedule or play multiple rounds
              in one session.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our word game generator has entertained thousands of players worldwide, creating countless memorable
              ...
              unforgettable gaming experience. Start your first round now and discover why this party game has become
              one of the most popular social deduction games of the decade!
            </p>
          </motion.div>
        </motion.div>
      </div>
